 ...
 */
type DISEASES_IMPL struct { }

/**
 * TODO: Add Description
 * @param    string        diseaseId      parameter: Required
 * @return	Returns the interface{} response from the API call
 */
func (me *DISEASES_IMPL) GetDisease (
            diseaseId string) (interface{}, error) {
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *DISEASES_IMPL) SearchDiseases (
